...
write.table(t1,"out/DOWN_BAP1mutants_vs_nonMutans.Accessibility.20210713.tsv",sep='\t',quote=F)
...
write.table(t1,"out/UP_BAP1mutants_vs_nonMutans.Accessibility.20210713.tsv",sep='\t',quote=F)
