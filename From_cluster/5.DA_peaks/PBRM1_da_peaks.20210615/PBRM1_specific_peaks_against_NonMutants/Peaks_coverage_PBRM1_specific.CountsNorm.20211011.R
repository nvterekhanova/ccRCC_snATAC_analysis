...
write.table(t1,"out/Accessibility.Counts/DOWN_PBRM1mutants_vs_nonMutans.Accessibility.20211011.tsv",sep='\t',
quote=F,row.names=F)
...
write.table(t1,"out/Accessibility.Counts/UP_PBRM1mutants_vs_nonMutans.Accessibility.20211011.tsv",sep='\t',quote=F,
row.names=F)
