...
ref_group_names=Fibroblasts,Macrophages,Endothelial_cells,NK_cells
...
docker run --ulimit stack=33554432:33554432 --user $(id -u):$(id -g) -v ${dir_run}:${dir_run} ${docker_image_name} inferCNV.R \
